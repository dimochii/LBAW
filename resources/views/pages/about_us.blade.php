...
@section('content')
    ...
    <div class="container mx-auto px-8 py-8 relative z-10">
        ...
        <div class="flex space-x-12 justify-center">
            <div class="backdrop-blur-lg shadow-2xl p-8 rounded-lg shadow-md text-center border border-gray-200 w-1/3">
                <div class="bg-pastelGreen rounded-full w-20 h-20 flex items-center justify-center mb-6 mx-auto shadow-lg group-hover:animate-spin-slow">
            ...
            <div class="backdrop-blur-lg shadow-2xl rounded-2xl p-8 rounded-lg shadow-md text-center border border-gray-200 w-1/3">
                <div class="bg-pastelBlue rounded-full w-20 h-20 flex items-center justify-center mb-6 mx-auto shadow-lg group-hover:animate-pulse">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="backdrop-blur-lg shadow-2xl rounded-2xl p-8 rounded-lg shadow-md text-center border border-gray-200 w-1/3">
                <div class="bg-pastelRed rounded-full w-20 h-20 flex items-center justify-center mb-6 mx-auto shadow-lg group-hover:animate-bounce">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-white" viewBox="0 0 24 24" fill="currentColor">
