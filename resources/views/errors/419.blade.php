...
<div class="min-h-screen flex items-center justify-center text-gray-800">
    <div class="bg-white border-2 border-black shadow-2xl p-16 max-w-3xl text-center relative animate-pulse">
        <div class="flex items-center justify-center mb-8">
            ...
            <h1 class="tracking-tighter font-medium text-6xl animate-bounce">1</h1>
            <h1 class="tracking-tighter font-medium text-6xl animate-bounce">9</h1>
        </div>
        <h1 class="tracking-tighter font-medium text-4xl animate-bounce">Page Expired</h1>
        <p class="text-2xl font-medium mb-8 animate-pulse">
        Sorry, your session has expired. Please refresh the page or return to the home page.
        </p>
